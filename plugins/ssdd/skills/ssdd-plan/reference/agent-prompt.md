...
3. Global design docs: `.ssdd/design/design.md` and all `.ssdd/design/DOMAIN_*/domain.md` files. Then, based on which domains are relevant to the stories and tasks, read only the `COMP_*.md` files within those domains — do NOT load all component files upfront.
