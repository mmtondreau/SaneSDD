---
name: ssdd-feature
description: Define a new feature specification interactively. Use when the user wants to create a new feature, define requirements, or start the SaneSDD workflow for a new piece of work.
...
```bash
"${CLAUDE_PLUGIN_ROOT}/scripts/ssdd-util.sh" files-to-review feature <feature-name>
```
