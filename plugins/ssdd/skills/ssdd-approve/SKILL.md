---
name: ssdd-approve
description: Approve artifacts after review. Run after reviewing the output of any SaneSDD step (feature, design, stories, tasks, plan).
...
|--------------|-----------|
| `feature` | `/ssdd-design <feature-name>` |
| `design` | `/ssdd-stories <epic-name>` |
| `stories` | `/ssdd-tasks <epic-name>` |
| `tasks` | `/ssdd-plan <epic-name>` |
| `plan` | `/ssdd-implement <epic-name>` |
